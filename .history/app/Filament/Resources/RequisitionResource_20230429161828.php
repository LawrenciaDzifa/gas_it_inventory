        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('created_at')
                    ->dateTime('d-M-Y'),
                    Tables\Actions\Actionxs::make('Approve')
                ->variant('success')
                ->onClick(fn (Requisition $requisition) => $requisition->update(['status' => 'approved']))
                ->visible(fn (Requisition $requisition) => $requisition->$this->status === 'pending'),
            ])
            ->filters([
                //
            ])
