                ...
                Action::make('approve')
                    ...
                    ->action(
                        ...
                        function (Model $record) {
                            // check the status of the requisition, if it is already approved, do nothing, if it is pending, update it to approved,if it is denied, show a flash message that 
                            ;
                            $user = Auth::user();
