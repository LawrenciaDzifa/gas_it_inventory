                ...
                Action::make('approve')
                    ...
                    ->action(
                        ...
                        function (Model $record) {
                            // check the status of the requisition, if it is already approved, do nothing, if it is pending, update it to approved,if it is denied, show a flash message that it has been denied
                            if ($record->status == 'approved') {
                                Flash::error('This requisition has already been approved.');
