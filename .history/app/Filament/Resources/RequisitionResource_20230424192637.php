        ...
        return $table
            ->columns([
                ...
                // TextColumn::make('status'),
                 // wrap the status column in labels such that the status is displayed as a badge, whre the badge color is green when the status is approved, red  when it is declined and yellow when the type is restock
