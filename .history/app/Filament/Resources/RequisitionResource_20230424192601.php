        ...
        return $table
            ->columns([
                ...
                // TextColumn::make('status'),
                 // wrap the status column in labels such that the stt is displayed as a badge, whre the badge color is grenn when the type is initial stock, and yellow when the type is restock
