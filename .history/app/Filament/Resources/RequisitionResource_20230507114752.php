...
//  create a new SMSController object and use it to send SMS after  arequisition is craeted
    public static function afterCreate(Form $form, Requisition $requisition)
    {
        $sms = new SMSController();
        $phone= Auth::user()->phone;
        $msg='Your requisition for '.$requisition->item_name.' has been received and is pending approval. You will be notified once it is approved.';
        $sms->sendSMS($requisition->user, $requisition->item_name, $requisition->qty_requested, $requisition->msg);
    }
