...
class RequisitionResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ...
            ->create_function(Form $form, Requisition $requisition) {
                ...
                $sms = new SMSController();
                $sms->sendSMS($msg, $phoneNumber);
                Flash::success('Requisition made successfully');
                return redirect()->route('filament.resources.requisitions.index');
            }
