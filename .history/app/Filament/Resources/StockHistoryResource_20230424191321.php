    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                // wrap the type column in labels such that the type is displayed as a badge, whre the badge color is grenn when the type is initial stock, and yellow when the type is restock, and gray when the type is unknown
