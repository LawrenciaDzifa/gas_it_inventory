    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                // wrap the status column in labels such that the status is displayed as a badge, where approves is green, pending is yellow and declined is red, using getStateUsin
