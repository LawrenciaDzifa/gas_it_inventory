...
class RequisitionResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ...
            $msg='Hello '.$user->name.', your requisition has been submitted successfully. You';

            // Send an SMS notification to the user
            $smsController = new SMSController();
            $smsController->sendSMS($phoneNumber, 'Your requisition has been submitted successfully.');
            })
            ;
    }
