...
// after record is stored, send sms to user informing them that their requisition has been received and is pending approval using the smscontroller
            ->record(function (Requisition $requisition) {
