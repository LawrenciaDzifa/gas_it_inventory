    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                // wrap the type column in labels such that the type is displayed as a badge, whre the badge color is grenn when the type is initial stock, and yellow when the type is restock
                TextColumn::make('type')->getStateUsing(function (Model $record) {
                    if ($record->type == 'initial_stock') {
                        return '<span class="badge badge-success">Initial Stock</span>';
                    } else {
                        return '<span class="badge badge-warning">Restock</span>';
                    }
                })->html,
