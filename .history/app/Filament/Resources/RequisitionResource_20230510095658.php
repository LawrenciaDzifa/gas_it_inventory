    ...
    public static function form(Form $form): Form
    {
        return $form
            ...
            ->create_function(function ($form) {
                ...
                $userMessage = 'Hi, your requisition was succesful and is pending approval.';

                // Send the SMS messages
                $sms = new SMSController();
                $sms->send($adminPhoneNumber, $adminMessage);
                $sms->send($userPhoneNumber, $userMessage);
            });
    }
